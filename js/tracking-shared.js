...
(function () {
  try {
    ...
    var keys = ['utm_source', 'utm_medium', 'utm_campaign', 'utm_term', 'utm_content', 'utm_id', 'src', 'sck', 'fbclid'];
    var fresh = {};
...
(function () {
  ...
  try {
    ...
    phone = _tkPhoneBR(localStorage.getItem('telefone') || localStorage.getItem('telephone') || '');
  } catch (e) {}
  var eid = _tkEid();
